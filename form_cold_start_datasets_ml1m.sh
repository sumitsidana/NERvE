...
./spark-submit --class "main.scala.write_items_ml1m"  --packages com.databricks:spark-csv_2.11:1.4.0 --total-executor-cores 50 --executor-memory 20G --driver-memory 20G --conf spark.driver.maxResultSize=5G  ~/recnet_draft/code/scala/target/scala-2.11/simple-project_2.11-1.0.jar
...
./spark-submit --class "main.scala.write_new_items_ml1m"  --packages com.databricks:spark-csv_2.11:1.4.0 --total-executor-cores 50 --executor-memory 20G --driver-memory 20G --conf spark.driver.maxResultSize=5G  ~/recnet_draft/code/scala/target/scala-2.11/simple-project_2.11-1.0.jar
...
./spark-submit --class "main.scala.write_data_new_u_old_i_ml_1m"  --packages com.databricks:spark-csv_2.11:1.4.0 --total-executor-cores 50 --executor-memory 20G --driver-memory 20G --conf spark.driver.maxResultSize=5G  ~/recnet_draft/code/scala/target/scala-2.11/simple-project_2.11-1.0.jar

echo "writing old users new items file"

./spark-submit --class "main.scala.write_data_old_u_new_i_ml_1m"  --packages com.databricks:spark-csv_2.11:1.4.0 --total-executor-cores 50 --executor-memory 20G --driver-memory 20G --conf spark.driver.maxResultSize=5G  ~/recnet_draft/code/scala/target/scala-2.11/simple-project_2.11-1.0.jar

echo "writing new users new items file"

./spark-submit --class "main.scala.write_data_new_u_new_i_ml_1m"  --packages com.databricks:spark-csv_2.11:1.4.0 --total-executor-cores 50 --executor-memory 20G --driver-memory 20G --conf spark.driver.maxResultSize=5G  ~/recnet_draft/code/scala/target/scala-2.11/simple-project_2.11-1.0.jar
