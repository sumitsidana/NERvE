...
set output "PlotMap_ML1M.eps";
set datafile separator " "
set yrange [0.65:1]
set xrange [-1:20]
set key spacing 2
set key top right
plot  'embeddings_ml1m' using ($4):xticlabels(1) with linespoints ls 1 title 'NervE_c', \
 '' using ($2):xticlabels(1) with linespoints ls 2 title 'NervE_p', \
 '' using ($3):xticlabels(1) with linespoints ls 3 title 'NervE_{c,p}'
