set terminal postscript eps color solid font 'Helvetica,17'
...
set output "PlotMap_Alpha_KASANDR.eps";
set xtic rotate by -35 scale 0
set datafile separator " "
set yrange [0.94:0.98]
set xrange [-1:10]
set key spacing 2
set key bottom right
set key spacing 1.7
plot  'alpha_kasandr' using ($2):xticlabels(1) with linespoints ls 1 title 'MAP\@1', \
