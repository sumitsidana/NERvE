...
df = pd.read_csv('/data/sidana/recnet_draft/cold_start/ics/'+sys.argv[1]+'/recnet_all/test_all_raw.csv',sep=',',header=0)
...
df2.to_csv('/data/sidana/recnet_draft/cold_start/ics/'+sys.argv[1]+'/recnet_all/test_all_cart_raw.csv', index = False)