#!/usr/bin/env bash
mkdir -p /data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/vectors

end_lf=20
reg_params="0.0001 0.001 0.005 0.01 0.05"
hidden_units="16 32 64"

for  latent_factor in $(seq 16 $end_lf); do
    for reg in $reg_params; do
        for num_units in $hidden_units; do
            ...
            ./writerelevancevectorrecnet_param_tune_all.sh netflix 01 one >>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
            echo -e -n "map@5: ">>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
            ./writerelevancevectorrecnet_param_tune_all.sh netflix 01 five>>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
            ...
            echo -e -n "map@1: ">>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
            ./writerelevancevectorrecnet_param_tune_all.sh netflix 10 one>>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
            echo -e -n "map@5: ">>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
            ./writerelevancevectorrecnet_param_tune_all.sh netflix 10 five>>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
            echo -e -n "map@10:" >>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
           ...
           echo -e -n "map@1: ">>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
            ./writerelevancevectorrecnet_param_tune_all.sh netflix 11 one>>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
           echo -e -n "map@5: ">>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
            ./writerelevancevectorrecnet_param_tune_all.sh netflix 11 five>>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
           echo -e -n "map@10:" >>/data/sidana/recnet/all_test_param_tune/netflix/recnet_all/15_20/results
