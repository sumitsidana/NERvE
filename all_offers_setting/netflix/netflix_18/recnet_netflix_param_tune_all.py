...
raw_data_train = np.loadtxt('/data/sidana/recnet/all_test_param_tune/'+sys.argv[1]+'/recnet_all/18/train_all_raw.csv', skiprows = 1, delimiter=',')
raw_data_test = np.loadtxt('/data/sidana/recnet/all_test_param_tune/'+sys.argv[1]+'/recnet_all/18/test_all_raw.csv', skiprows = 1, delimiter=',')
...
export_basename = '/data/sidana/recnet/all_test_param_tune/'+sys.argv[1]+'/recnet_all/18/vectors/'
