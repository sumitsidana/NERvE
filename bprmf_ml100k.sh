...
./item_recommendation --training-file=/data/recnet_draft/ml100k/bprmf/train.inputbprmf --test-file=/data/recnet_draft/ml100k/bprmf/test.inputbprmf --test-users=/data/recnet_draft/ml100k/bprmf/test.users --recommender=BPRMF --recommender-options=num_factors=50 reg_u=0.0001 reg_i=0.0001 reg_j=0.0001 learn_rate=0.001 num_factors=3 --in-test-items  --prediction-file=/data/recnet_draft/ml100k/bprmf/prediction_file
