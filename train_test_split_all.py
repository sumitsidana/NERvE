...
raw_data_train = np.loadtxt('/data/sidana/recnet/'+sys.argv[1]+'/recnet_all/train_all_raw.csv', skiprows = 1, delimiter=',')
raw_data_test = np.loadtxt('/data/sidana/recnet/'+sys.argv[1]+'/recnet_all/test_all_raw.csv', skiprows = 1, delimiter=',')
...
export_basename = '/data/sidana/recnet/'+sys.argv[1]+'/recnet_all/vectors/'
