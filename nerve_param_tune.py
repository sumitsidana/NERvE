...
raw_data_train = np.loadtxt('/data/sidana/recnet/param_tune/'+sys.argv[1]+'/recnet/train_all_raw.csv', skiprows = 1, delimiter=',')
raw_data_test = np.loadtxt('/data/sidana/recnet/param_tune/'+sys.argv[1]+'/recnet/test_all_raw.csv', skiprows = 1, delimiter=',')
...
export_basename = '/data/sidana/recnet/param_tune/'+sys.argv[1]+'/recnet/vectors/'
