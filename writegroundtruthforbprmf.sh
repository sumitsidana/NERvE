...
java -cp ~/nnmf_ranking/nnmf_ranking/java/ preProcess.WriteGroundTruthForBPRMF  "/data/recnet_draft/$1/bprmf/test.inputbprmf" "/data/recnet_draft/$1/bprmf/vectors/gt_ml20m"
