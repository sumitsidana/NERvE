javac -cp ~/nnmf_ranking/java/src/binaries/commons-lang3-3.5.jar  ~/nnmf_ranking/java/src/preProcess/InputOutput.java ~/nnmf_ranking/java/src/preProcess/WriteGroundTruthForbprmf.java
LANG=en_US.utf8
