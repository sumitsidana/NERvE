...
model = bprnn.BPR_NN(N_USERS, N_ITEMS, N_EMBEDDINGS, alpha=0.0, beta=1.0, alpha_reg=0.0, inner_net=inner_network)
model.build_graph()
...
export_pred = open(export_basename + 'pr_10_01', 'w')
export_true = open(export_basename + 'gt_10_01', 'w')
