...
class TripletsDataset(object):
    ...
    def train_test_split(self, n_train, seed=None):
        ...
        f_train = open('/data/sidana/nnmf_ranking/archive_version/outbrain/input_data/test/train_temp','w')
        f_test = open('/data/sidana/nnmf_ranking/archive_version/outbrain/input_data/test/test_temp', 'w')
