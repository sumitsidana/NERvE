...
raw_data_train = np.loadtxt('/data/sidana/recnet/recnet_alpha_all_offers_setting/'+sys.argv[1]+'/train_all_raw.csv', skiprows = 1, delimiter=',')
raw_data_test = np.loadtxt('/data/sidana/recnet/recnet_alpha_all_offers_setting/'+sys.argv[1]+'/test_all_raw.csv', skiprows = 1, delimiter=',')
...
export_basename = '/data/sidana/recnet/recnet_alpha_all_offers_setting/'+sys.argv[1]+'/vectors/'
