...
object write_data_old_u_new_i_ml100k {
...
trainUsersItems.coalesce(1,false).saveAsTextFile("/data/sidana/recnet_draft/cold_start/data/ml100k/dat.ml100k.oldusersnewitems")
	}
}
