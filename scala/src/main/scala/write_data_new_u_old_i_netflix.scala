...
object write_data_new_u_old_i_netflix {
...
trainUsersItems.coalesce(1,false).saveAsTextFile("/data/sidana/recnet_draft/cold_start/data/netflix/dat.netflix.newusersolditems")
	}
}
