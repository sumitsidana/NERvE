...
object write_data_old_u_old_i_kasandr {
...
filetobewritten.coalesce(1,false).saveAsTextFile("/data/sidana/recnet_draft/cold_start/data/kasandr/dat.kasandr.oldusersolditems")
	}
}
